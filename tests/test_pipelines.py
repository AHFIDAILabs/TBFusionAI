...
class TestAudioPreprocessor:
    ...
    def test_extract_features_with_validation(self, sample_audio_bytes):
        ...
        try:
            ...
            audio_io.seek(0)
            try:
                features_validated = preprocessor.extract_features(
                    audio_io, validate_quality=True
                )
...
class TestFeaturePreprocessor:
    ...
    def test_encode_features_already_numeric(self):
        ...
        features = {"sex": 1, "tb_prior": 0, "hemoptysis": 1, "age": 45}
    ...
    def test_prepare_feature_dict(
        self, sample_clinical_features, sample_audio_features
    ):
        """Test feature dictionary preparation."""
        preprocessor = FeaturePreprocessor()

        combined = preprocessor.prepare_feature_dict(
            sample_clinical_features, sample_audio_features
        )
