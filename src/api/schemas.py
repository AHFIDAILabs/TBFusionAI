...
class PredictionResponse(BaseModel):
    ...
    # Added to prevent 'model_' namespace conflict warnings
    model_config = {
    ...
    model_config = {
        ...
        "json_schema_extra": {
            "example": {
                ...
                "performance": {"recall": 0.95, "f1": 0.92},
            }
        },
    }
...
class AudioMetrics(BaseModel):
    ...
    FIXED: Added clipping_ratio and silence_ratio to resolve
    Pylance 'Unknown Parameter' and test failures.
    """
