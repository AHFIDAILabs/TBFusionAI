...
class TBPredictor:
    ...
    async def predict_from_audio(
        ...
        try:
            ...
            audio_features = self.audio_preprocessor.extract_features(audio_input, validate_quality)
            ...
            if generate_spectrogram:
                ...
                spectrogram_image = self.audio_preprocessor.generate_spectrogram(audio_input)
    ...
    def get_model_info(self) -> Dict:
        ...
        return {
            ...
            'feature_count': self.metadata.get(
                'n_features', 
                len(self.metadata.get('feature_columns', []))
            ),
